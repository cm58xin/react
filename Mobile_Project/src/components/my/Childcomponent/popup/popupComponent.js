					...
					<div className="popup_content">
						<div className="popup_content_header">
	                        ...
	                        <p className="passwordBox">
	                        	{
		                        	<span>
			                      		<input  key="input1" type="password" placeholder={this.props.data[0]+1? '·':null}/>
										<input  key="input2" type="password" placeholder={this.props.data[1]+1? '·':null}/>
										<input  key="input3" type="password" placeholder={this.props.data[2]+1?	'·' :null}/>
										<input  key="input4" type="password" placeholder={this.props.data[3]+1?	'·' :null}/>
										<input key="input5"  type="password" placeholder={this.props.data[4]+1? '·':null}/>
										<input  key="input6" type="password" placeholder={this.props.data[5]+1? '·':null}/>
		                        	</span>
	                        	}
							</p>
						</div>
...
var mapState = function (state){
	console.log(state.popup.show1);
	return{
		data:state.popup.data || [],
		show1:state.popup.show1 ==undefined ? true : state.popup.show1
	}
}
