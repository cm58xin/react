...
import * as SoldAction from './SoldAction';
...
class SoldComponent extends React.Component{
    constructor(props) {
     super(props);
  }
      ...
      return (
        <div id="Right">
            ...
            <div className="SalingTop">
                ...
                <Breadcrumb.Item href="#/home/onSale"><Icon type="user" /><span>交易管理</span></Breadcrumb.Item><Breadcrumb.Item><Icon type="gift" />已出售</Breadcrumb.Item></Breadcrumb>
...
export default connect(mapStateToProps, SoldAction)(SoldComponent)
