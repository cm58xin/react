...
import * as SalingAction from './SalingAction';
...
class SalingComponent extends React.Component{
    constructor(props) {
     super(props);
  }
...
export default connect(mapStateToProps, SalingAction)(SalingComponent)
