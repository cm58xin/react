...
import * as MemberListAction from './MemberListAction';
      ...
      return (
        <div id="Right">
            ...
            <div className="SalingTop">
                ...
                <Breadcrumb.Item href="#home/MemberList"><Icon type="user" /><span>用户管理</span></Breadcrumb.Item><Breadcrumb.Item><Icon type="gift" />用户列表</Breadcrumb.Item></Breadcrumb>
...
export default connect(mapStateToProps, MemberListAction)(MemberListComponent)
