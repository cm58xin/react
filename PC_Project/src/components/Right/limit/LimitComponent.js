...
import * as LimitAction from './LimitAction';
...
class LimitComponent extends React.Component{
    constructor(props) {
     super(props);
  }
      ...
      return (
        <div id="Right">
            ...
            <div className="SalingTop">
                ...
                <Breadcrumb.Item href="#/home/Limit"><Icon type="user" /><span>权限设置</span></Breadcrumb.Item><Breadcrumb.Item><Icon type="gift" />用户权限</Breadcrumb.Item></Breadcrumb>
            ...
            <div className="LimitMain">
                <p >
                  ...
                  <input type="text"  placeholder="请输入搜索条件"  className="sousuo"/>
                   <Button icon="search"  onClick={this.sousuo.bind(this)}>Search</Button>
                </p>
...
export default connect(mapStateToProps, LimitAction)(LimitComponent)
